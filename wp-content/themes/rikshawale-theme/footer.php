...
<script>
// GA4 Custom Funnel Event Tracking Helper (Fires standard & custom funnel event names)
...
<a href="https://wa.me/<?php echo esc_attr($wa_number); ?>?text=<?php echo $wa_text; ?>" target="_blank" rel="noopener noreferrer" id="rikshawale-whatsapp-float" title="Chat on WhatsApp" aria-label="Chat on WhatsApp">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="34" height="34" fill="currentColor">
...
#rikshawale-whatsapp-float svg,
#rikshawale-whatsapp-float i {
    filter: drop-shadow(0 2px 4px rgba(0,0,0,0.25));
    transition: transform 0.3s ease;
    display: block;
}
#rikshawale-whatsapp-float:hover svg,
