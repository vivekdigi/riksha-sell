<?php
/**
 * The template for displaying all pages (Supports Elementor & Default Editor)
 */
...
while ( have_posts() ) : the_post();
    if ( $is_elementor ) :
        // Full width for Elementor builder pages
        ?>
        <main id="primary" class="site-main elementor-page-content">
            <?php the_content(); ?>
        </main>
        <?php
    else :
        // Default Gutenberg / Classic Editor Page Layout with Container & Premium Header
        ?>
