...
// Fetch Theme Mod / Customizer values with defaults matching screenshot
$phone         = get_theme_mod( 'contact_phone',         get_theme_mod( 'topbar_phone', '+91 97111-63000' ) );
$email         = get_theme_mod( 'contact_email',         get_theme_mod( 'topbar_email', 'EliteCarzIndia@gmail.com' ) );
$address       = get_theme_mod( 'contact_address',       'Indra Market, CB-382, Ring Rd, Block CB, Naraina Village, Naraina, New Delhi, Delhi 110028' );
$working_hours = get_theme_mod( 'contact_working_hours', get_theme_mod( 'topbar_hours', 'Mon-Sun: 11:00am - 7:00pm' ) );
$intro_text    = get_theme_mod( 'contact_intro_text',    'EliteCarz is a pre-owned car dealership in Delhi NCR, offering handpicked, fully inspected vehicles with warranty and complete peace of mind.' );
?>
