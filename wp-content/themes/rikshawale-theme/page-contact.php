...
$address       = get_theme_mod( 'footer_address',       get_theme_mod( 'contact_address', '' ) );
$working_hours = get_theme_mod( 'topbar_hours',          get_theme_mod( 'contact_working_hours', '' ) );
$form_title    = get_theme_mod( 'contact_form_title',   '' );
$intro_text    = get_theme_mod( 'contact_intro_text',    get_theme_mod( 'footer_description', '' ) );
?>
