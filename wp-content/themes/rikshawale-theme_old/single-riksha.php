        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6">
                ...
                <div class="card border-0 rounded-3 p-4 shadow-sm" style="background-color: var(--light-color); border-top: 4px solid var(--primary-color) !important;">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <?php $contact_phone = get_theme_mod('topbar_phone') ? get_theme_mod('topbar_phone') : '+919999999999'; ?>
                            <a href="tel:<?php echo esc_attr( preg_replace('/[^0-9+]/', '', $contact_phone) ); ?>" class="btn btn-danger btn-lg fw-bold w-100 py-3 uppercase" style="background-color: var(--primary-color); border-color: var(--primary-color); font-size: 0.9rem;"><i class="fa fa-phone me-2"></i> Call Showroom</a>
                        </div>
                        <div class="col-sm-6">
